...
public class HamcrestMatchersApiTest {
     //this will be no testng ..
    //this is gonna be 4th way for verifying the Json Response.We will be using HamcrestMathcers to changing RestAssured library.
   ...
   And json body/ data has following
       "id": 15,
       "name": "Meta",
       "gender": "Female",
       "phone": 1938695106
